...
public class UtilisationVer1 {
    ...
    public static void testMappings1() {
        ...
        System.out.println("\n remise ‡ 0 des compteurs partiels de tous les vÈhiculess!");
        System.out.println(garage);

        garage.faireLePleinAll();
        System.out.println("\n faire le plein de tous les vÈhicules s'il reste moins de 10 litres !");
        System.out.println(garage);
    }
     ...
     * l'on rÈfÈrence ensuite par un garage CompteurComparable
     * en effet, les vÈhicules ayant tous un compteur ‡ 0 lors de leur instanciation ne seraient pas ajoutÈs
     * ‡ un garage CompteurComparable, car un Set est sans doublon par rapport au critËre de comparaison
     */
